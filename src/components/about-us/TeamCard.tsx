...
const TeamCard: React.FC<TeamCardProps> = (props) => {
  return (
    <div className="flex h-[288px] w-[245px] flex-col overflow-hidden rounded-2xl border-1 border-gray-100 bg-white shadow-md md:h-[350px] md:w-[280px] lg:h-[380px] lg:w-[280px]">
      <div className="relative p-3 pb-0 md:p-4 lg:p-5">
        <div className="overflow-hidden rounded-xl">
          <img
            src={props.profileImage ?? ''}
            alt={props.consultantName ?? ''}
      ...
      <div className="flex flex-col px-4 pt-2 pb-3 md:px-5 md:pt-0 lg:px-6 lg:pt-0">
        <div className="mb-2 flex items-center justify-between md:mb-3">
          ...
          {props.facebookAccount && (
            <a
              ...
              aria-label={`View ${(props.consultantName ?? '')}'s profile`}
            >
        ...
        <div className="flex flex-1 flex-col justify-between">
          <div className="text-body-6 md:text-body-4 lg:text-body-6 space-y-1 md:space-y-2">
            <p className="text-text-primary font-semibold">Consultant</p>
