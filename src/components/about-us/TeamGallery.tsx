...
const TeamGallery: React.FC<TeamGalleryProps> = ({
  members,
  ...
  return (
    <div className="w-full py-12">
      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        <div
          ref={containerRef}
          className="relative h-[380px] cursor-grab overflow-hidden select-none active:cursor-grabbing md:h-[550px] lg:h-[550px]"
