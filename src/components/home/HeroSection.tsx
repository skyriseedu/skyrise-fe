    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full">
        <div className="w-full max-w-7xl px-6 pt-14 sm:px-6 lg:px-10 lg:pt-20">
          <div>
            <h1 className="mb-6 text-[40px] font-semibold text-white md:text-[48px] lg:text-[75px]">
              {t('home.hero.title')
                .split('\n')
                .map((line, index) => (
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.facebook.com/share/15HjhMzHVKE/?mibextid=wwXIfr" target="_blank" className="hover:opacity-80">
                <img
                  src={facebookWhite}
              ...
              <a href="https://youtube.com/@skyriseedu105?si=AqeuU5RykkNKnYb2" target="_blank" className="hover:opacity-80">
                <img
                  src={youtubeWhite}
              ...
              <a href="https://t.me/skyrise105" target="_blank" className="hover:opacity-80">
                <img
                  src={telegramWhite}
